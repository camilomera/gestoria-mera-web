...
export default function Footer() {
  return (
    <footer className="bg-dark-900 border-t border-cream-300/10">
      <div className="container-custom mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
          {/* Brand */}
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-white">Gestoría Mera</h3>
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col gap-3">
              ...
              <Link href="/seguros-perros" className="text-white/60 hover:text-accent transition-colors text-sm">
                Seguros para Perros
              </Link>
              <Link href="/seguros-caballos" className="text-white/60 hover:text-accent transition-colors text-sm">
                Seguros para Caballos
              </Link>
              <Link href="/contacto" className="text-white/60 hover:text-accent transition-colors text-sm">
                Contacto
              </Link>
            </nav>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:986651478" className="text-white/60 hover:text-accent transition-colors">
                  986 651 478
                </a>
              </div>
              <div className="flex items-center gap-3">
                ...
                <a href="https://wa.me/34667755976" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-accent transition-colors">
                  667 755 976
                </a>
              </div>
            </div>
