      ...
      <div className="container-custom mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <Link href="/" className="flex items-center">
            <span className="text-2xl sm:text-[1.6rem] font-black text-white tracking-tight">
              Gestoría Mera
            </span>
          </Link>
          ...
          <div className="hidden lg:flex items-center">
            <a
              ...
              className="group flex items-center gap-2.5 bg-white/10 hover:bg-white/15 border border-white/20 hover:border-orange/40 text-white px-5 py-2.5 rounded-xl transition-all duration-300"
            >
              ...
              <span className="text-sm font-bold">667 755 976</span>
            </a>
          </div>
          ...
          <div className="px-4 py-6 space-y-1">
            ...
            <div className="pt-4 mt-4 border-t border-white/10">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2.5 bg-white/10 border border-white/20 text-white font-bold text-base w-full py-3.5 rounded-xl"
              >
